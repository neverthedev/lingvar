...
export default function MianownikiMnogaExercisePage() {
  const { isAuthenticated, isLoading } = useAuth()
  const router = useRouter()
  const exerciseId = 'mianownik-mnoga' // Hardcoded for this specific exercise
  const exerciseUrl = 'mianownik/mnoga'
        ...
        <div className="sticky top-0 z-10 bg-white border-b border-gray-200 pb-4 mb-6">
          <div className="text-center mb-4">
            <Typography variant="h3" className="mb-2">
              Practice Mianowniki Liczby Mnogiej
            </Typography>
            <Typography variant="body" color="secondary">
              Type the correct Polish noun form. You have 3 attempts per word.
            </Typography>
          </div>
                    ...
                    {word.status === 'correct' ? (
                      ...
                      <div className="flex items-center gap-2">
                        <Input
                          ...
                          placeholder="Enter Polish noun form..."
                          className="flex-grow"
